...
Route::middleware(['auth:api'])->group(function(){
    ...
    Route::resource('users',UserController::class )->only(['index','show','update','destroy']);//->middleware('auth:api');
    Route::post('register', [AuthController::class, 'register']);
    // ExamPeriod routes (admin)
    // Route::resource('exam-periods', ExamPeriodController::class)->only(['store','update','destroy']);
    // // Course routes (admin)
...
//         // ExamPeriod routes (student)
//         // Route::resource('exam-periods', ExamPeriodController::class)->only(['index', 'show']);
